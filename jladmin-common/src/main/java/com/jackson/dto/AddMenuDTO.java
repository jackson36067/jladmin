...
public class AddMenuDTO implements Serializable {
    ...
    public AddMenuDTO(Long pid, Integer type, String title, String name, String component, String menuSort, String icon, String path, Boolean iFrame, Boolean cache, Boolean hidden, String permission) {
        this.pid = pid;
        this.type = type;
        this.title = title;
        this.name = name;
