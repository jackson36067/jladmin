...
public class QuartzLogVO implements Serializable {
    ...
    public QuartzLogVO(String jobName, String className, String cronExpression, String exceptionDetail, Long time, Boolean isSuccess, LocalDateTime createTime) {
    ...
    public boolean equals(Object o) {
        ...
        QuartzLogVO that = (QuartzLogVO) o;
